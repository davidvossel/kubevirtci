# Kubernetes 1.13.7 in ephemeral containers

Provides a pre-deployed Kubernetes with version 1.13.7 purely in docker
...
```bash
export KUBEVIRT_PROVIDER=k8s-1.13.7
...
node01    NotReady   master    31s       v1.13.7
node02    NotReady   <none>    5s        v1.13.7
```
