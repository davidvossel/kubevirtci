...
* `k8s-1.13.7` k8s-1.13.7 cluster based on the centos7 image, provisioned with kubeadm
...
* `kubevirtci/k8s-1.13.7:`: `sha256:9be913b292e838cafa05d8a00f5368cd45e6accb93528586ed6e2d83d65e7e6d`
